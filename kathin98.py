...
for key, pkts in flows.items():
    ...
    features = {
        'Protocol': protocol, 'Flow Duration': flow_duration, 'Total Fwd Packets': len(fwd_pkts),
        'Total Backward Packets': len(bwd_pkts), 'Fwd Packets Length Total': sum(fwd_pkt_lengths),
        'Bwd Packets Length Total': sum(bwd_pkt_lengths), 'Fwd Packet Length Max': fwd_len_max,
        ...
        'Packet Length Min': pkt_len_min, 'Packet Length Max': pkt_len_max, 'Packet Length Mean': pkt_len_mean,
        ...
        'Avg Packet Size': pkt_len_mean, 'Avg Fwd Segment Size': fwd_len_mean, 'Avg Bwd Segment Size': bwd_len_mean,
        ...
        'Init Fwd Win Bytes': init_win_fwd, 'Init Bwd Win Bytes': init_win_bwd, 'Fwd Act Data Packets': act_data_pkt_fwd,
        'Fwd Seg Size Min': min_seg_size_fwd, 'Active Mean': active_mean, 'Active Std': active_std, 'Active Max': active_max,
